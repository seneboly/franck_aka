jQuery(document).ready(function () {
    ...
    if (getCookie('ct_panacea.switcher') == 'hide') {
        hideStyleswitcher();
    }

    /** style chooser show/hide **/
    jQuery("#stylechooser  #styleToggle").click(function () {
        setCookie('ct_panacea.switcher', $chooser.css('left') == '0px' || $chooser.css('left') == '-1px' ? 'hide' : 'show');
    ...
    function store() {
        ...
        setCookie('ct_panacea', r);
    }

    function load() {
        d = getCookie('ct_panacea');
        if (d) {
