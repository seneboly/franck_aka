...
jQuery(document).ready(function ( $ ) {
    ...
    /**
     * Size of portfolio home page
    **/
    jQuery('.gallery-grid a:nth-child(1)').find('img').css('margin-right','0px');
    jQuery('.gallery-grid a:nth-child(4)').find('img').css('height','11rem');
    jQuery('.gallery-grid a:nth-child(5)').find('img').css({'height':'11rem', 'margin-right':'0px'});
});
