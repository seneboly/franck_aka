...
<p align="center">
  <a href="{{route('home')}}"><img src="{{asset('/template/uploads/imgs/franck_logo.png')}}" width="150" alt="" /></a>
</p>
</tr>
</tbody>
</table>
<table class="status-container single" style="width:auto">
<tbody>
  <tr>
  <td class="body-padding">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</td>
  <td class="body-padded">
  <div class="body-title"><b>Expéditeur</b> : {{$msg->name}},</div>
  <table class="body-text">
  <tbody>
  <tr>
  <td class="body-text-cell" style="width: 100%">
    <p style="text-align: justify;">{{$msg->content}}</p>
  </td>
  </tr>
<tr>
<td class="status-padding" style="width: 252px;">&nbsp;</td>
<td class="status-padding" style="width: 253px;">&nbsp;</td>
</tr>
</tbody>
</table>

<div style="text-align: left;"><a style="background-color: #41cc00; background-image: url('https://www.filepicker.io/api/file/N8GiNGsmT6mK6ORk00S7'); border: 1px solid #407429; border-radius: 4px; color: #ffffff; display: inline-block; font-family: sans-serif; font-size: 17px; font-weight: bold; text-shadow: -1px -1px #47A54B; line-height: 38px; text-align: center; text-decoration: none; width: 190px; -webkit-text-size-adjust: none; mso-hide: all;" href="{{route('home')}}">Aller sur le site</a></div>
<table class="body-signature-block">
<tbody>
<tr>
<td class="body-signature-cell">
<p>Cordialement,</p>
<p class="body-signature">Franck AKA</p>
</td>
</tr>
</tbody>
</table>
